...
if __name__ == "__main__":
    db = pymysql.connect(host="localhost",user="root",password="123456",db="movies",charset="utf8",port = 3306)
    cursor = db.cursor()
    ...
    cursor = db.cursor()
    conn = pymysql.connect(host='localhost', user='root', password='123456', port=3306, db='movies',
                           charset='utf8mb4')
    cursor = conn.cursor()
    #输出评分top10
